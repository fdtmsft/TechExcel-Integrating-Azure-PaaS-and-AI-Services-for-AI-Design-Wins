...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId,[Description("The date to use as reference")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Fetch bookings without assigned hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Fetch bookings with multiple assigned hotel rooms.")]
